...
// Configurações do LiveReload
const liveReloadServer = imports.livereload.createServer();
liveReloadServer.watch(imports.path.join(__dirname, "../public"));  // Observando a pasta 'public'

app.use(imports.connectLivereload());
